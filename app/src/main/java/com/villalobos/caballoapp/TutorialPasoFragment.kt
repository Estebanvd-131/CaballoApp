...
class TutorialPasoFragment : Fragment() {
    ...
    private fun configurarPaso(paso: TutorialPaso) {
        ErrorHandler.safeExecute(
            ...
            binding.tvTituloPaso.setTextColor(ContextCompat.getColor(requireContext(), R.color.text_primary))
            binding.tvDescripcionPaso.text = paso.descripcion
            binding.tvDescripcionPaso.setTextColor(ContextCompat.getColor(requireContext(), R.color.text_primary))
